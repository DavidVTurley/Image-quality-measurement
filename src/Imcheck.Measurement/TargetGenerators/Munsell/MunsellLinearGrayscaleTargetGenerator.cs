...
public sealed class MunsellLinearGrayscaleTargetGenerator : ITargetGenerator<MunsellLinearGrayscaleTargetGeneratorOptions, MunsellLinearGrayscaleTargetGeneratorResult>
{
    ...
    {
        return TargetRendering.ScaleAverage(value, scaleX, scaleY);
    }
